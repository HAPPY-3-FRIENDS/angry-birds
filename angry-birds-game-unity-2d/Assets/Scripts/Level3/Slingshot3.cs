...
public class Slingshot3 : MonoBehaviour
{
    ...
    public Bird[] birdPrefab =  new Bird[8];
    ...
    void Update()
    {
        ...
        {
            if (currentBird == 2 || currentBird == 3)
            {
                isSkilled = true;
                YellowSkill();
            }
            ...
            if (currentBird == 4 || currentBird == 5 || currentBird == 6 || currentBird == 7)
            {
                isSkilled = true;
                BlueSkill();
            }
