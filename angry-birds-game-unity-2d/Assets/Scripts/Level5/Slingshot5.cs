...
public class Slingshot5 : MonoBehaviour
{
    ...
    public Bird[] birdPrefab =  new Bird[6];
    public GameObject[] pig = new GameObject[4];
    int pigCount = 4;
    ...
    void Update()
    {
        ...
        if (endWin == true && currentBird <= 6)
        {
            result = 2;
        } else

        if (endWin == true && currentBird <= 7)
        {
            result = 1;
        }
        ...
        if (currentBird == 2 || currentBird == 4 || currentBird == 6)
        {
        ...
        {
            if (currentBird == 3 || currentBird == 5)
            {
                isSkilled = true;
                YellowSkill();
            }
